...
class Browser:
	@staticmethod
	def _configure_driver(driver: selenium.webdriver.Remote, resolution: str):
		try:
	...
	def __init__(self, browser: str = 'firefox', **kwargs):
		capabilities = dict(
	...
	@property
	def driver(self) -> selenium.webdriver.Remote:
		return self._driver
